...
export const Settings = {
  ...
  saveBaseUrl: () => {
    browser.storage.local.set({ baseUrl: DOM.baseUrlInput.value });
  },
  ...
  saveMaxTokens: () => {
    browser.storage.local.set({ maxTokens: DOM.maxTokensInput.value });
  },

  saveEnableHistory: () => {
    browser.storage.local.set({ enableHistory: DOM.enableHistoryCheckbox.checked });
    UI.updateInputPlaceholder();
  },

  saveEnableRag: () => {
    browser.storage.local.set({ enableRag: DOM.enableRagCheckbox.checked });
  },
